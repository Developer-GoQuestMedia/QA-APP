...
export default function DirectorDialoguePage({ params }: PageProps) {
  const router = useRouter()
  const { data: session, status } = useSession()

  // Log initial params
  console.log('DirectorDialoguePage - Initial params:', {
  ...
  console.log('Rendering DirectorDialogueView with:', {
