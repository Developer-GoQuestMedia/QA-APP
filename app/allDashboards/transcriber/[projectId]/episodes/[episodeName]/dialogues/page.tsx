...
export default function TranscriberDialoguePage({ params }: PageProps) {
  const router = useRouter()
  const { data: session, status } = useSession()

  // Log initial params
  console.log('TranscriberDialoguePage - Initial params:', {
  ...
  console.log('Rendering TranscriberDialogueView with:', {
