    ...
    <div className="min-h-screen bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex justify-between items-center center mb-6">
          <h1 className="text-2xl font-bold text-center text-white">Transcriber Dashboard</h1>
          {/* <button
        ...
        {filteredProjects.length === 0 ? (
          <div className="text-center p-8 bg-gray-800 rounded-lg">
            <p className="text-gray-400">No projects assigned to you as a transcriber.</p>
          </div>
        ) : (
